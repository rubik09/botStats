...
export class CalculatedStatsRepository {
  constructor(
    @InjectMetric(CounterMetricsConfig.DB_REQUEST_CALCULATED_STATS_TOTAL.name) private dbRequestTotal: Counter<string>,
    @InjectMetric(HistogramMetricsConfig.DB_REQUEST_CALCULATED_STATS_DURATION.name)
